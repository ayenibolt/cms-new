...
{
$sql=mysqli_query($con,"SELECT password FROM  admin where password='".password_hash($_POST['password'], PASSWORD_BCRYPT)."' && username='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update admin set password='".password_hash($_POST['newpassword'],PASSWORD_BCRYPT)."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
