        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="https://jidescms.herokuapp.com/users/login.php">User Login</a>
                    </li>
                    <li>
...
<!--                     <li>
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; <a href="http://www.phpgurukul.com/">PHPGURUKUL</a> | Complaint Management System 2019</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
